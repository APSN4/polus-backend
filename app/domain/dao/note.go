...
type Note struct {
	...
	PhotoCloudsUrl []string `gorm:"column:photo_clouds_url; type:string[]" json:"photo_clouds_url"`
	NatureEvents   []string `gorm:"column:nature_events; type:string[]" json:"nature_events"`
